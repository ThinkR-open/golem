...
This adds a series of packages as dependecies to your app. See `?golem::use_recommended_deps` for the list.
...
These two functions adds one file each which contain a series of functions that can be useful for building your app. To be used in the UI, in the server, or as prod-dependent tools.
...
_see the `run_dev.R` file in the dev directory_ 
