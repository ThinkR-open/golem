...
The `{golem}` package is part of the [`{golemverse}`](https://golemverse.org/).
A list of various `{golem}` related resources can be found [here](https://golemverse.org/resources/).
