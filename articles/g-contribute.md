...
`master` is:
[![R-CMD-check](https://github.com/ThinkR-open/golem/actions/workflows/R-CMD-check.yaml/badge.svg?branch=master)](https://github.com/ThinkR-open/golem/actions/workflows/R-CMD-check.yaml)
