...
From time to time, you need your application to be unavailbel: database update, API changes, etc.
...
```
export GOLEM_MAINTENANCE_ACTIVE=TRUE && Rscript -e "mypkg::run_app()"
```
